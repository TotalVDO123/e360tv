...
@section('content')
            ...
            <div class="row gy-3">
                ...
                <div class="col-md-12">
                    <div class="row gy-3">
                      ...
                      <!-- ratnesh -->
                        <div class="col-md-12">
                                {{ html()->label(__('Live Stream Type'), 'type')->class('form-label') }}
                          <div class="d-flex align-items-center gap-3">
                                    <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0">
                                        <div>
                                            <input class="form-check-input" type="radio" name="live_stream_type" id="LIVETV"
                                                value="LIVETV" onchange="show_hide_url()"
                                               checked>
                                            <span class="form-check-label">{{ __('Live TV') }}</span>
                                        </div>
                                    </label>
                                    <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0">
                                        <div>
                                            <input class="form-check-input" type="radio" name="live_stream_type" id="LIVESTREAM"
                                                value="LIVESTREAM" onchange="show_hide_url()"
                                               >
                                            <span class="form-check-label">{{ __('Live Stream') }}</span>
                                        </div>
                                    </label>
                                </div> 
                                ...
                                <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0">
                                    <div>
                                        <input class="form-check-input" type="radio" name="access" id="free"
                                            ...
                                            {{ old('access') == 'free' ? 'checked' : 'checked' }}>
                ...
                <?php /* ?>
                 ...
                 <?php */ ?>       
                         ...
                         <div class="col-md-6 col-lg-6" id="type_url">
                                {{ html()->label(__('movie.lbl_trailer_url_type') , 'lbl_trailer_url_type')->class('form-label') }}
                                {{ html()->select('trailer_url_type', $url->pluck('name', 'value')->prepend(__('placeholder.lbl_select_type'), ''), old('trailer_url_type', ''))->class('form-control select2')->id('trailer_url_type')->disabled(false) }}
                        ...
                        <div class="col-md-6 col-lg-6 " id="url_input">
                    ...
                    <div id="video-inputs-container-parent">
                     ...
                     <!--------------------------------------------------->       
                       ...
                       <!------------------------------------------------------------------------->       
                         ...
                         <div class="col-md-6 col-lg-6">
                                {{ html()->label(__('Rtmp Server'), 'type')->class('form-label') }}
                              
                                {{ html()->text('rtmp_server')->placeholder(__('Rtmp Server'))->class('form-control')->id('rtmp_server') }}
                         ...
                         <div class="col-md-6 col-lg-6">
                                {{ html()->label(__('Rtmp Key'), 'type')->class('form-label') }}
                              
                                {{ html()->text('rtmp_key')->placeholder(__('Rtmp Key '))->class('form-control')->id('rtmp_key') }}
                            ...
                            <div class="col-md-6 col-lg-6">
                            {{ html()->label(__('Upcoming (Start Date)') , 'upcoming_date')->class('form-label') }}
                          <!--  {{ html()->date('upcoming_date')->placeholder(__('movie.lbl_upcoming_date'))->class('form-control datetimepicker')->attribute('required', 'required')->id('upcoming_date') }} -->
                          
                          {{ html()->input('datetime-local', 'upcoming_date', isset($data->upcoming_date) ? date('Y-m-d\TH:i', strtotime($data->upcoming_date)) : '')
    ->class('form-control')
    ...
    ->id('release_date') }}
                 ...
                 <div class="col-md-6 col-lg-6">
                            {{ html()->label(__('Upcoming (End Date)') , 'upcoming_end_date')->class('form-label') }}
                          <!--  {{ html()->date('upcoming_date')->placeholder(__('movie.lbl_upcoming_date'))->class('form-control datetimepicker')->attribute('required', 'required')->id('upcoming_date') }} -->
                          
                          {{ html()->input('datetime-local', 'upcoming_end_date', isset($data->upcoming_end_date) ? date('Y-m-d\TH:i', strtotime($data->upcoming_end_date)) : '')
    ->class('form-control')
    ->attribute('required', 'required')
    ->id('release_date') }}
                   ...
                   <?php /* ?>
                     <div class="col-md-6 col-lg-6">
                           {{ html()->label(__('Duration') , 'duration')->class('form-label') }}
                            <input
                                type="text"
                                name="duration"
                                id="duration"
                       ...
                       <?php */ ?> 
                         ...
                         <div class="col-md-6 col-lg-6">
                                {{ html()->label( 'Recurring Program', 'recurring_program')->class('form-label') }}
                                <div class="d-flex justify-content-between align-items-center form-control">
                                    {{ html()->label('Recurring Program', 'recurring_program')->class('form-label mb-0 text-body') }}
                                    <div class="form-check form-switch">
                                      
                                        {{ html()->checkbox('recurring_program', old('recurring_program', false))->class('form-check-input')->id('recurring_program') }}
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                               <div class="mb-3">
                                <label for="days_of_week" class="form-label">Day(s) of Week</label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="days_of_week"
                    ...
                    <div class="mb-3">
                        ...
                        <select name="days_of_week" id="days_of_week" class="form-control">
                            <option value="">Select Day</option>
                            <option value="Monday" {{ old('days_of_week') == 'Monday' ? 'selected' : '' }}>Monday</option>
                            <option value="Tuesday" {{ old('days_of_week') == 'Tuesday' ? 'selected' : '' }}>Tuesday</option>
                            <option value="Wednesday" {{ old('days_of_week') == 'Wednesday' ? 'selected' : '' }}>Wednesday</option>
                            <option value="Thursday" {{ old('days_of_week') == 'Thursday' ? 'selected' : '' }}>Thursday</option>
                            <option value="Friday" {{ old('days_of_week') == 'Friday' ? 'selected' : '' }}>Friday</option>
                            <option value="Saturday" {{ old('days_of_week') == 'Saturday' ? 'selected' : '' }}>Saturday</option>
                            <option value="Sunday" {{ old('days_of_week') == 'Sunday' ? 'selected' : '' }}>Sunday</option>
                        </select>
                    </div>
                </div>
                    ...
                    <!--------------------------------------------------------------------------->        
                            ...
                            <div class="col-md-6 col-lg-4 live_url_show_hide">
                            ...
                            <!-- Select Box for URL -->
                            <div class="col-md-6 col-lg-4 d-none live_url_show_hide" id="type_url">
                            ...
                            <!-- URL Input Fields -->
                            <div class="col-md-6 col-lg-4 d-none live_url_show_hide" id="server_url_section">
...
@push('after-scripts')
   ...
   <script>
    function show_hide_url() {

        // Get selected radio value
        let selectedType = document.querySelector('input[name="live_stream_type"]:checked').value;

        // Get all divs with class
        let urlDivs = document.querySelectorAll('.live_url_show_hide');

        urlDivs.forEach(function(div) {

           // alert(selectedType);

            // Hide when Live TV selected
            if (selectedType === 'LIVETV') {
                //div.classList.add('d-none');
                div.classList.remove('d-none');
            } else {
                // Show when Live Stream selected
                //div.classList.remove('d-none');
                div.classList.add('d-none');
                
            }
            
              document.getElementById('stream_type').value = 'HLS';
              
              document.getElementById('server_url')
            .setAttribute('value', 'https://vz-8eb2b474-655.b-cdn.net/playlist.m3u8');
