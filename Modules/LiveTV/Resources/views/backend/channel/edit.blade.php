...
<?php
//echo "<pre>";
//print_r($data->TvChannelStreamContentMappings);
//exit;
?>
...
@section('content')
            ...
            <div class="row gy-3">
                                    ...
                                    <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0">
                                        <div>
                                            <input class="form-check-input" type="radio" name="live_stream_type" id="LIVETV"
                                               ...
                                               {{ $data->live_stream_type == 'LIVETV' ? 'checked' : '' }}>
                                    ...
                                    <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0">
                                        <div>
                                            <input class="form-check-input" type="radio" name="live_stream_type" id="LIVESTREAM"
                                               ...
                                               {{ $data->live_stream_type == 'LIVESTREAM' ? 'checked' : '' }} >
                ...
                <!---------------------trailer_url_type------------------------>
                 ...
                 <div class="col-md-6 col-lg-6" id="type_url">
                                ...
                                {{ html()->select('trailer_url_type', $url->pluck('name', 'value')->prepend(__('placeholder.lbl_select_type'), ''), 
                                 $data->TvChannelStreamContentMappings->trailer_url_type ,
                                old('trailer_url_type', ''))->class('form-control select2')->id('trailer_url_type')->disabled(false) }}
                        ...
                        <div class="col-md-6 col-lg-6 " id="url_input">
                            ...
                            {{ html()->text('trailer_url')->attribute('value',  $data->TvChannelStreamContentMappings->trailer_url)->placeholder(__('placeholder.lbl_trailer_url'))->class('form-control') }}
                ...
                <div id="enable_quality_section" class="col-md-12 enable_quality_section">
                    <div id="video-inputs-container-parent">
                     ...
                     <!------------------------------------------------------------------------->       
                         ...
                         <div class="col-md-6 col-lg-6">
                                ...
                                {{ html()->text('rtmp_server', $data->TvChannelStreamContentMappings->rtmp_server ?? '')->placeholder(__('Rtmp Server'))->class('form-control')->id('rtmp_server') }}
                         ...
                         <div class="col-md-6 col-lg-6">
                                ...
                                {{ html()->text('rtmp_key', $data->TvChannelStreamContentMappings->rtmp_key ?? '' )->placeholder(__('Rtmp Key '))->class('form-control')->id('rtmp_key') }}
                        ...
                        <!--    {{ html()->date('upcoming_date')->attribute('value', $data->TvChannelStreamContentMappings->upcoming_date ? \Carbon\Carbon::parse($data->TvChannelStreamContentMappings->upcoming_date)->format('Y-m-d') : '')->placeholder(__('Upcoming Date'))->class('form-control datetimepicker') }} -->
                      {{ html()->input(
                            'datetime-local',
                            'upcoming_date',
                            $data->TvChannelStreamContentMappings->upcoming_date
                                ? \Carbon\Carbon::parse($data->TvChannelStreamContentMappings->upcoming_date)->format('Y-m-d\TH:i')
                                : ''
                        )
                        ->placeholder(__('Upcoming (Strat Date)'))
                        ->class('form-control')
                        ->id('upcoming_date')
                    }}
                    ...
                    {{ html()->input(
                            'datetime-local',
                            'upcoming_end_date',
                            $data->TvChannelStreamContentMappings->upcoming_end_date
                                ? \Carbon\Carbon::parse($data->TvChannelStreamContentMappings->upcoming_end_date)->format('Y-m-d\TH:i')
                                : ''
                        )
                        ->placeholder(__('Upcoming (End Date)'))
                        ->class('form-control')
                         ...
                         <?php /* ?>
                           ...
                           {{ html()->label(__('Duration') , 'duration')->class('form-label') }}
                            <input
                                ...
                                value="{{ $data->TvChannelStreamContentMappings->duration }}">
                        </div>
                         ...
                         <div class="col-md-6 col-lg-6">
                                ...
                                <div class="d-flex justify-content-between align-items-center form-control">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        {{ html()->checkbox('recurring_program', $data->TvChannelStreamContentMappings->recurring_program )->class('form-check-input')->id('recurring_program') }}
                                    </div>
                                </div>
    ...
    $selectedDay = trim(old('days_of_week', $data->TvChannelStreamContentMappings->days_of_week ?? ''));
