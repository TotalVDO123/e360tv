...
<?php /* ?>
     ...
     <?php */ ?>      
         ...
         <div class="slick-general {{ $type == 'pay-per-view' ? 'slick-general-pay-per-view' : '' }}" data-items="4.5"
            data-items-desktop="5.5" data-items-laptop="4.5" data-items-tab="2.2" data-items-mobile-sm="1.5"
            data-items-mobile="1.5" data-speed="1000" data-autoplay="false" data-center="false" data-infinite="false"
            data-navigation="true" data-pagination="false" data-spacing="12">
