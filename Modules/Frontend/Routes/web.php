...
Route::get('/embed/tv-shows/{slug?}', [TvShowController::class, 'tvShowListEmbed'])->defaults('slug', 'e360films')->name('tv-shows.embed');
...
Route::get('/live_list', [MovieController::class, 'livetvList'])->middleware('checkModule')->name('livetv');




Route::get('/livetv-details/{id}/{is_live?}', [MovieController::class, 'liveTvDetails'])->middleware('checkModule')->name('livetv-details');
