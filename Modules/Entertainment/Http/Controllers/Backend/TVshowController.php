...
class TVshowController extends Controller
{
    ...
    public function create()
      {
        ...
        ->select('id', 'order', 'name', 'image', 'banner_image')
        ...
        return view('entertainment::backend.tvshows.create', compact('upload_url_type','assets','plan','movie_language','genres','numberOptions','actors','directors','countries','video_quality','type','module_title','mediaUrls','page_type','seriesNetworks'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('entertainment::backend.tvshows.edit', compact('data','tmdb_id','assets','upload_url_type','plan','movie_language','genres','countries','numberOptions','actors','directors','mediaUrls','module_title','seo','clips','page_type','seriesNetworks'));
