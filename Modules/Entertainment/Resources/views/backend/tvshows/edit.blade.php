                            ...
                            <div class="col-md-4 col-lg-4 d-none" id="embed_input">
                               ...
                               <?php /* ?>
                                @error('trailer_embedded')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div class="invalid-feedback" id="trailer-embed-error">
                ...
                <div class="card-body">
                    <div class="row gy-3">
                        ...
                        <?php /* ?>    
                            ...
                            @enderror
                            <div class="invalid-feedback" id="name-error">{{ __('messages.release_date_field_required') }}
                            </div>
                        <?php */ ?>    
                        ...
                        <!---------------------------------------------->
                           ...
                           <div class="col-md-6 col-lg-4">
                            {{ html()->label(__('Networks') . '<span class="text-danger">*</span>', 'networks')->class('form-label') }}
                            {{ html()->select('network_id[]', $seriesNetworks->pluck('name', 'id'), explode(',', $data->network_id)  )->class('form-control select2')->id('networks')->multiple()->attribute('required', 'required') }}
                            @error('genres')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <div class="invalid-feedback" id="name-error">{{ __('messages.genres_field_required') }}</div>
