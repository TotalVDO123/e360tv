                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-4 col-lg-4 mb-3">
                                ...
                                @error('trailer_url_type')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div class="invalid-feedback" id="name-error">{{ __('messages.trailer_type_field_required') }}
                                </div>
                            ...
                            <div class="col-md-4 col-lg-4 d-none" id="embed_input">
                                {{ html()->label(__('movie.lbl_embed_code') , 'trailer_url_embedded')->class('form-label form-control-label') }}
                                ...
                                <label class="form-check form-check-inline form-control cursor-pointer w-auto m-0">
                                    <div>
                                        <input class="form-check-input" type="radio" name="movie_access"
                                            id="free" value="free"
                                            onchange="showPlanSelection(this.value === 'paid')"
                                            {{ old('movie_access') == 'free' ? 'checked' : 'checked' }}>
                ...
                <div class="card-body">
                    ...
                    <?php /* ?>
                            @error('IMDb_rating')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <div class="invalid-feedback" id="imdb-error">{{ __('messages.imdb_rating_field_required') }}
                            </div>
                      <?php */ ?>  
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            {{ html()->date('release_date')->attribute('value', old('release_date'))->placeholder(__('movie.lbl_release_date'))->class('form-control datetimepicker')->id('release_date') }}
                            ...
                            @error('release_date')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <div class="invalid-feedback" id="release_date-error">{{ __('messages.release_date_field_required') }}
                            </div>
                        ...
                        <!----------------------------------->
                         <div class="col-md-6 col-lg-4">
                            {{ html()->label(__('Networks') , 'networks')->class('form-label') }}
                            {{ html()->select('network_id[]', $seriesNetworks->pluck('name', 'id')->prepend(__('Select Networks'), ''), old('networks'))->class('form-control select2')->id('networks')->multiple()->attribute('required', 'required') }}
                            @error('genres')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <div class="invalid-feedback" id="name-error">{{ __('messages.genres_field_required') }}</div>
