   ...
   <?php */ ?>
            ...
            <div>
                ...
                <div class="input-group flex-nowrap">
                  ...
                  <a href="{{ url('app/network-order-list') }}"
                        class="btn btn-primary d-flex align-items-center gap-1" id="add-post-button">Update Order</a>
                
                
                @hasPermission('add_networks')
                    <a href="{{ url('app/network-create') }}"
...
@push('after-scripts')
    ...
    <script type="text/javascript" defer>
        const columns = [{
                name: 'check',
                data: 'check',
                title: '<input type="checkbox" class="form-check-input" name="select_all_table" id="select-all-table" data-type="Networks"  onclick="selectAllTable(this)">',
                width: '0%',
                exportable: false,
                orderable: false,
                searchable: false,
    ...
    {
        data: 'order_your_shows',
        name: 'order_your_shows',
        orderable: false,
        searchable: false,
        title: "Series Order"
    }
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            initDatatable({
               url: "{{ url('app/network_index_data') }}",
                finalColumns,
                orderColumn: [
                    [4, "desc"]
                ],
