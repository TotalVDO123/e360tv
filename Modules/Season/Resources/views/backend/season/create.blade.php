                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="mb-3">
                               ...
                               <?php /* ?>     
                                @error('trailer_url_type')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div class="invalid-feedback" id="name-error">Trailer Type field is required
                                </div>
                            ...
                            <div class="d-none" id="embed_input">
                                {{ html()->label(__('movie.lbl_embed_code'), 'trailer_embedded')->class('form-label form-control-label') }}
