...
class GenerateMenus
{
    ...
    public function handle()
    {
        return \Menu::make('menu', function ($menu) {
            ...
            $permissionsToCheck = ['view_genres', 'view_networks', 'view_movies', 'view_tvshow', 'view_seasons','view_episodes','view_videos','view_livetv',
            ...
            $this->mainRoute($menu, [
                ...
                'route' => 'backend.networks',
                'title' => 'Networks',
                'active' => ['app/networks','app/networks/*'],
